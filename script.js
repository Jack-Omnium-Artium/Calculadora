...
function suma(simbolo){
     numeroactual = operacionesjava.innerText; // Obtener el contenido actual del div
            ...
            if (numeroactual.endsWith('+')|| numeroactual.endsWith('00')|| numeroactual.endsWith('-')|| numeroactual.endsWith('/')|| numeroactual.endsWith('*')) {
...
function ejecutaroperacion(){
    ...
    let operacionejecutada = eval(numeroactual);
